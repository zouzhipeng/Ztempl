        ...
        if(value){
            if(notbind){//不绑定for节点
                ...
                for(var vi in value.child){
                    ...
                    if(value.child[vi].$value() == '2017年11月'){
                        console.log(value);
                    }
                    this.build_tag([copy_node],value.child[vi].$value());
...
function get_data(key,data,default_value){
    ...
    for(var i=0,ii=key_path.length;i<ii;i++){
        ...
        if(i == (ii-1)){
            ...
            if(!parent[key_path[i]])parent[key_path[i]]={};
            ...
            set: function(newVal) {
                ...
                if(data.for_nodes){
                    ...
                    for(var i=0,ii=data.for_nodes.length;i<ii;i++) {
                        ...
                        obje_append(data.for_nodes[i].for_node_templ,for_box);
